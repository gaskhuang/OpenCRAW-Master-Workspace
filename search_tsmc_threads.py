...
class TSMCTreadsScraper:
    ...
    def search_by_keyword(self, keyword: str, max_scrolls: int = 60) -> List[Dict[str, Any]]:
        """使用關鍵字搜索相關帖子"""
...
def main():
    ...
    try:
        ...
        # 使用多個關鍵字搜索
        keywords = ["台積電", "TSMC", "台積電 股價", "台積電 股票"]
        
        for keyword in keywords:
            print(f"\n[搜索] 關鍵字: {keyword}")
            posts = scraper.search_by_keyword(keyword, max_scrolls=50)
