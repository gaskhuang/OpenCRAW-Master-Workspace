...
Steps:
  ✓ clean check (50ms)
  ✓ git fetch (1.86s)
  ✓ git checkout v2026.3.13-beta.1 (42ms)
  ✓ deps install (1.98s)
  ✓ build (33.82s)
  ✓ ui:build (1.64s)
  ✓ openclaw doctor (10.94s)
  ✓ git rev-parse HEAD (after) (18ms)
...
│ Gateway service │ LaunchAgent installed · loaded · running (pid 22904, state active)                                 │
│ Node service    │ LaunchAgent not installed                                                                          │
│ Agents          │ 1 · no bootstrap files · sessions 3 · default hq active 2h ago                                     │
...
├────────────────────────────────────────────┼────────┼─────────┼───────────────────┼──────────────────────────────────┤
│ agent:hq:telegram:direct:713279…           │ direct │ 2h ago  │ claude-sonnet-4-6 │ 60k/200k (30%) · 🗄️ 99% cached   │
│ agent:hq:main                              │ direct │ 3h ago  │ claude-opus-4-6   │ 126k/200k (63%) · 🗄️ 100% cached │
│ agent:hq:telegram:slash:7132792…           │ direct │ 10d ago │ claude-sonnet-4-6 │ unknown/200k (?%)                │
└────────────────────────────────────────────┴────────┴─────────┴───────────────────┴──────────────────────────────────┘
