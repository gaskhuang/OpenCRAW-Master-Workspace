...
│ Update          │ available · git HEAD · dirty · fetch failed · npm update 2026.3.13 · deps ok                      │
│ Gateway         │ local · ws://127.0.0.1:18789 (local loopback) · reachable 41ms · auth token · userdeMacBook-Pro.  │
...
├────────────────────────────────────────────┼────────┼─────────┼───────────────────┼─────────────────────────────────┤
│ agent:hq:telegram:direct:713279…           │ direct │ 1m ago  │ gpt-5.4           │ 228k/200k (114%) · 🗄️ 1% cached │
│ agent:hq:main                              │ direct │ 8h ago  │ claude-sonnet-4-6 │ 179k/200k (90%) · 🗄️ 97% cached │
│ agent:hq:telegram:slash:7132792…           │ direct │ 9d ago  │ claude-sonnet-4-6 │ unknown/200k (?%)               │
└────────────────────────────────────────────┴────────┴─────────┴───────────────────┴─────────────────────────────────┘
