...
### clawdhub
- branch: main
- commit: 6318a74 -> d725a38
```text
 src/lib/site.ts                                  |   19 +-
 src/lib/useAuthError.test.ts                     |   22 +
 src/lib/useAuthError.ts                          |   33 +
 src/routes/cli/auth.tsx                          |   34 +-
 src/routes/management.tsx                        |  619 +++++++--
 src/routes/skills/index.tsx                      |    4 +-
 src/styles.css                                   |  134 +-
 86 files changed, 5060 insertions(+), 649 deletions(-)
 create mode 100644 convex/functions.ts
 create mode 100644 convex/lib/manualOverrides.test.ts
 create mode 100644 convex/lib/manualOverrides.ts
 create mode 100644 convex/lib/skillSearchDigest.test.ts
 create mode 100644 convex/lib/skillSearchDigest.ts
 create mode 100644 convex/skills.manualOverrides.test.ts
 create mode 100644 convex/skills.publicModeration.test.ts
 create mode 100644 convex/skills.staffAuditLogs.test.ts
 create mode 100644 src/components/AppProviders.test.tsx
 create mode 100644 src/components/SkillSecurityScanResults.test.tsx
 create mode 100644 src/lib/useAuthError.test.ts
 create mode 100644 src/lib/useAuthError.ts
```
...
```text
fatal: unable to access 'https://github.com/halthelobster/proactive-agent/': Resolving timed out after 722945 milliseconds
...
│ Update          │ available · git HEAD · dirty · fetch failed · npm update 2026.3.11 · deps ok                      │
│ Gateway         │ local · ws://127.0.0.1:18789 (local loopback) · reachable 91ms · auth token · userdeMacBook-Pro.  │
│                 │ local (192.168.1.110) app 2026.3.7 macos 26.3                                                     │
│ Gateway service │ LaunchAgent installed · loaded · running (pid 43680, state active)                                │
│ Node service    │ LaunchAgent not installed                                                                         │
│ Agents          │ 1 · no bootstrap files · sessions 3 · default hq active 6h ago                                    │
...
├─────────────────────────────────────────────┼────────┼─────────┼───────────────────┼────────────────────────────────┤
│ agent:hq:telegram:direct:713279…            │ direct │ 6h ago  │ gpt-5.4           │ 63k/200k (31%) · 🗄️ 98% cached │
│ agent:hq:main                               │ direct │ 37h ago │ claude-sonnet-4-6 │ 42k/200k (21%) · 🗄️ 96% cached │
│ agent:hq:telegram:slash:7132792…            │ direct │ 7d ago  │ claude-sonnet-4-6 │ unknown/200k (?%)              │
└─────────────────────────────────────────────┴────────┴─────────┴───────────────────┴────────────────────────────────┘
