...
Steps:
  ...
  ✓ build (1027.76s)
  ✓ ui:build (1.97s)
  ✓ openclaw doctor (973.21s)
  ✓ git rev-parse HEAD (after) (87ms)
...
│ Gateway service │ LaunchAgent installed · loaded · running (pid 53167, state active)                                 │
│ Node service    │ LaunchAgent not installed                                                                          │
│ Agents          │ 1 · no bootstrap files · sessions 3 · default hq active 5h ago                                     │
...
├────────────────────────────────────────────┼────────┼─────────┼───────────────────┼──────────────────────────────────┤
│ agent:hq:telegram:direct:713279…           │ direct │ 5h ago  │ claude-sonnet-4-6 │ 93k/200k (46%) · 🗄️ 99% cached   │
│ agent:hq:main                              │ direct │ 46h ago │ claude-opus-4-6   │ 101k/200k (51%) · 🗄️ 100% cached │
│ agent:hq:telegram:slash:7132792…           │ direct │ 12d ago │ claude-sonnet-4-6 │ unknown/200k (?%)                │
└────────────────────────────────────────────┴────────┴─────────┴───────────────────┴──────────────────────────────────┘
