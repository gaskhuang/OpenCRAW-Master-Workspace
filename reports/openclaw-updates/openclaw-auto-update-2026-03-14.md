...
│ Update          │ available · git HEAD · dirty · fetch failed · npm update 2026.3.12 · deps ok                      │
│ Gateway         │ local · ws://127.0.0.1:18789 (local loopback) · reachable 58ms · auth token · userdeMacBook-Pro.  │
...
├────────────────────────────────────────────┼────────┼─────────┼───────────────────┼─────────────────────────────────┤
│ agent:hq:telegram:direct:713279…           │ direct │ 3h ago  │ gpt-5.4           │ 196k/200k (98%) · 🗄️ 96% cached │
│ agent:hq:main                              │ direct │ 21h ago │ gpt-5.4           │ 218k/200k (109%) · 🗄️ 1% cached │
│ agent:hq:telegram:slash:7132792…           │ direct │ 8d ago  │ claude-sonnet-4-6 │ unknown/200k (?%)               │
└────────────────────────────────────────────┴────────┴─────────┴───────────────────┴─────────────────────────────────┘

FAQ: https://docs.openclaw.ai/faq
Troubleshooting: https://docs.openclaw.ai/troubleshooting

Update available (npm 2026.3.12). Run: openclaw update
