---
name: 跨平台比價購物 (Cross-Platform Price Comparison)/nodejs
description: "Use Case #021 Node.js 方案: 跨平台比價購物。使用 Node.js 實作 Cross-Platform Price Comparison 自動化系統。"
allowed-tools: Read, Grep, Glob, Bash(npm *), Bash(node *), Bash(npx *), Bash(mkdir *)
---

# Use Case #021: 跨平台比價購物 — Node.js 方案
...
安裝:
```bash
mkdir cross-platform-price-comparison && cd cross-platform-price-comparison
...
export async function collectData() {
  // TODO: Implement data collection for Cross-Platform Price Comparison
...
pm2 start src/index.js --name cross-platform-price-comparison  # 持久化
```
