---
name: 交易機器人監控 (Trading Bot Monitor)/python
description: "Use Case #141 Python 方案: 交易機器人監控。使用 Python 實作 Trading Bot Monitor 自動化系統。"
allowed-tools: Read, Grep, Glob, Bash(pip *), Bash(python *), Bash(mkdir *), Bash(touch *)
---

# Use Case #141: 交易機器人監控 — Python 方案
...
if __name__ == "__main__":
    result = run_trading_bot_monitor()
    print(result)
```
...
```bash
# 加入 crontab（每日執行）
# 0 9 * * * cd ~/trading-bot-monitor && python3 main.py >> output.log 2>&1
```
