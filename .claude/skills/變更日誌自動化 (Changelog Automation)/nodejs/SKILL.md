---
name: 變更日誌自動化 (Changelog Automation)/nodejs
description: "Use Case #074 Node.js 方案: 變更日誌自動化。使用 Node.js 實作 Changelog Automation 自動化系統。"
allowed-tools: Read, Grep, Glob, Bash(npm *), Bash(node *), Bash(npx *), Bash(mkdir *)
---

# Use Case #074: 變更日誌自動化 — Node.js 方案
...
安裝:
```bash
mkdir changelog-automation && cd changelog-automation
...
export async function collectData() {
  // TODO: Implement data collection for Changelog Automation
...
pm2 start src/index.js --name changelog-automation  # 持久化
```
