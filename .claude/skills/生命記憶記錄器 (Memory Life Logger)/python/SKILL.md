---
name: 生命記憶記錄器 (Memory Life Logger)/python
description: "Use Case #174 Python 方案: 生命記憶記錄器。使用 Python 實作 Memory Life Logger 自動化系統。"
allowed-tools: Read, Grep, Glob, Bash(pip *), Bash(python *), Bash(mkdir *), Bash(touch *)
---

# Use Case #174: 生命記憶記錄器 — Python 方案
...
```bash
# 加入 crontab（每日執行）
# 0 9 * * * cd ~/memory-life-logger && python3 main.py >> output.log 2>&1
```
