---
name: 自主專案管理 (Autonomous Project Management)/nodejs
description: "Use Case #029 Node.js 方案: 自主專案管理。使用 Node.js 實作 Autonomous Project Management 自動化系統。"
allowed-tools: Read, Grep, Glob, Bash(npm *), Bash(node *), Bash(npx *), Bash(mkdir *)
---

# Use Case #029: 自主專案管理 — Node.js 方案
...
安裝:
```bash
mkdir autonomous-project-management && cd autonomous-project-management
...
export async function collectData() {
  // TODO: Implement data collection for Autonomous Project Management
...
pm2 start src/index.js --name autonomous-project-management  # 持久化
```
